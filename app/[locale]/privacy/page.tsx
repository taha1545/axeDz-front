...
const sections = [
    {
        ...
        content: (
            <>
                <p>
                    AxeDz (&quot;we&quot;, &quot;us&quot;, or &quot;our&quot;) respects your privacy. This Privacy
                    Policy explains what information we collect when you use our website, dashboard,
                    and API, and how we use and protect it.
                </p>
                <p>
                    By using AxeDz, you agree to the collection and use of information as described
    ...
    },
    {
        ...
        content: (
            <>
                <p>We collect information you provide directly and information generated when you use our platform:</p>
                <ul className="list-disc space-y-2 pl-5">
                    ...
                    <li>
                        <strong className="text-foreground">Billing information</strong> — wallet
                        balance, transaction history, and payment records via SATIM
                    </li>
                    <li>
                        <strong className="text-foreground">API usage data</strong> — messages sent,
                        delivery status, API keys used, and request logs
                    </li>
                    <li>
                        <strong className="text-foreground">Contact data</strong> — phone numbers and
                        email addresses you store or message through our platform
                    </li>
                    <li>
                        <strong className="text-foreground">Technical data</strong> — IP address,
                        browser type, device information, and usage analytics
                    </li>
                </ul>
            </>
        ),
        ...
        content: (
            <>
                ...
                <ul className="list-disc space-y-2 pl-5">
                    ...
                    <li>Send service notifications, billing alerts, and support responses</li>
    ...
    },
    {
        ...
        content: (
            <>
                ...
                <ul className="list-disc space-y-2 pl-5">
                    <li>
                        <strong className="text-foreground">Service providers</strong> — SMS carriers,
                        email providers, payment processors (SATIM), and hosting partners who help us
                    ...
                    <li>
                        ...
                        with a merger, acquisition, or sale of assets, with notice to you
                    </li>
                    <li>
                ...
                <p>
                    Message content is transmitted to delivery providers solely to fulfill your
                    requests. We require partners to handle data securely and only for the intended
                    purpose.
                </p>
            </>
        ),
    },
    {
        ...
        content: (
            <>
                <p>
                    We retain your account information for as long as your account is active. Message
                    logs, transaction records, and API usage data are kept for billing, support, and
                    legal compliance purposes.
                </p>
                <p>
                    When you delete your account, we will delete or anonymize your personal data
                    within a reasonable period, except where retention is required by law or for
        ...
        content: (
            <>
                <p>
                    ...
                    encryption in transit (HTTPS), secure API key handling, access controls, and
                    rate limiting.
                </p>
                <p>
                    No method of transmission or storage is 100% secure. You are responsible for
                    keeping your password and API keys confidential. Report any suspected breach to{' '}
                    <a
        ...
        content: (
            <>
                <p>
                    ...
                    preferences, and understand how you use our website. Essential cookies are
    ...
    },
    {
        ...
        content: (
            <p>
                AxeDz is not intended for users under 18 years of age. We do not knowingly collect
    ...
    },
    {
        ...
        content: (
            <p>
                ...
                revised version on this page and update the &quot;Last updated&quot; date. Material
                changes may also be communicated via email or a dashboard notice.
            </p>
        ),
    },
    {
            ...
            <div className="mx-auto w-full max-w-3xl">
                ...
                <header className="mb-10 space-y-4 border-b-2  border-foreground pb-8 md:mb-12">
                    ...
                    <p className="text-base leading-relaxed text-muted-foreground sm:text-lg">
                        This policy explains how AxeDz collects, uses, and protects your personal
