...
import { SMS_ALL_STATUSES, SMS_STATUS_MAP } from '../constants';
...
export function SmsStatusFilter({ statusFilter, onStatusFilter }: SmsStatusFilterProps) {
        ...
        <div className="relative flex items-center gap-1">
            ...
            >
                ...
                <span className="capitalize">
                    {statusFilter ? (SMS_STATUS_MAP[statusFilter]?.label ?? statusFilter) : t('allStatus')}
                </span>
            </Button>
