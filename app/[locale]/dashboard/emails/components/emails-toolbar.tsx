...
import { EmailsStatusFilter } from './emails-status-filter';

interface EmailsToolbarProps {
    search: string;
...
export function EmailsToolbar({
    ...
    return (
        <div className="flex flex-col gap-3 rounded-[2rem] border border-primary/20 bg-card/60 px-4 py-4 sm:flex-row sm:flex-wrap sm:items-center sm:px-6">
            ...
            <EmailsStatusFilter statusFilter={statusFilter} onStatusFilter={onStatusFilter} />
