  ...
  return (
    <nav
      className={cn(
        "flex w-full",
        orientation === "horizontal"
          ? "items-center justify-center gap-3 md:gap-4 lg:gap-8 flex-nowrap"
      ...
      {links.map((link) => {
        ...
        return (
          <Link
            ...
            className={cn(
              "relative whitespace-nowrap text-sm md:text-md lg:text-[17px] font-semibold transition-colors duration-200 shrink-0 py-1.5",
