        ...
        <section className="bg-background px-4 py-16 md:px-6 md:py-24 lg:px-8">
            <div className="mx-auto max-w-7xl">
                ...
                <motion.div
                    ...
                    className={cn(
                        'relative overflow-hidden rounded-4xl border border-border bg-foreground dark:bg-card shadow-lg shadow-primary/15',
                        'px-6 py-10 sm:px-10 sm:py-15 md:px-12 lg:px-16'
                    )}
                >
