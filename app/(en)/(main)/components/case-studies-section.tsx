            ...
            <div className="mx-auto max-w-7xl">
                ...
                >
                    <div className="flex flex-col items-center text-center gap-3 sm:flex-row sm:text-start sm:items-start sm:gap-5">
                        <span className="inline-block w-fit  rounded-lg bg-foreground px-3 py-3 text-sm font-bold tracking-wide text-background sm:px-4 sm:py-4 sm:text-xl">
                            Case Studies
                        </span>
                        <h2 className="max-w-lg text-sm font-medium leading-snug text-muted-foreground sm:text-base md:max-w-xl md:text-lg">
                ...
                >
                    ...
                    <div className="relative grid grid-cols-1 gap-8 sm:grid-cols-2 sm:gap-6 md:grid-cols-3 md:gap-8 lg:gap-12">
                        {caseStudies.map((study, index) => (
                            ...
                            >
                                <h3 className="mb-2 text-base font-semibold text-background sm:text-lg md:text-xl">
                                    {study.title}
                                </h3>
                                <p className="mb-5 flex-1 text-sm leading-relaxed text-background/60 sm:mb-6 sm:text-base">
                                    {study.description}
                                </p>
                                <a
                                    href={study.href}
                                    className={cn(
                                        ...
                                        'text-background/80 transition-colors duration-200 hover:text-background'
                                    )}
                                >
                                    Learn more
