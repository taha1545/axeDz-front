...
const socialLinks = [
    { src: '/linkedin.svg', href: '#', label: 'LinkedIn' },
...
export function FooterSection() {
    ...
    return (
        <footer className="bg-foreground w-full mt-10 rounded-t-[2rem] max-w-7xl mx-auto px-4 pt-10 md:px-6 lg:px-8">
            <div>
                <motion.div
                ...
                >
                    ...
                    <div className="relative mb-10 flex flex-col items-start justify-between gap-8 sm:flex-row sm:items-center md:mb-14 lg:gap-12">
                        {/* Logo */}
                        <a href="#" className="relative h-8 w-28 md:h-9 md:w-32">
                            <Image
                                src="/logo.svg"
                                alt="AxeDz"
                                fill
                        ...
                        <nav className="flex flex-wrap items-center gap-x-6 gap-y-3 md:gap-x-8">
                            {navLinks.map((link) => (
                                <a
                                    key={link.label}
                                    href={link.href}
                                    className="relative text-sm text-background/80 transition-colors duration-200 hover:text-background"
                                >
                                    {link.label}
                                </a>
                            ))}
                    ...
                    <div className="relative grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-20">
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <a
                                        ...
                                        className="text-sm text-background transition-colors hover:text-white md:text-base"
                                    >
                                        support@axedz.com
                                    </a>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p className="text-sm leading-relaxed text-background md:text-base">
                                        Algeria, Alger 123 baba hsen B 50 N 2
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col mt-4 items-start lg:text-left">
                            <p className="mb-4 hidden text-sm text-background/60 lg:block">
                            ...
                            >
                                <input
                                    ...
                                    required
                                    className={cn(
                                        'min-w-0 flex-1 rounded-full border bg-transparent px-6 py-3.5 text-sm text-background transition-all duration-200',
                                        'border-background/30 placeholder:text-background/50',
                                        'focus:border-background/60 focus:outline-none focus:ring-2 focus:ring-background/10',
                                ...
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        'transition-all duration-200 hover:bg-background/90 active:scale-[0.97]'
                                    )}
                                >
                    ...
                    {/* Divider */}
                    <div className="relative my-2 border-t border-background/20 md:my-8" />

                    {/* Bottom */}
                    <div className="relative flex flex-col items-center justify-between gap-4 sm:flex-row">
                        <p className="text-xs text-background/60 md:text-sm">
