            ...
            {consent === 'pending' && (
                ...
                >
                    <motion.div
                        ...
                        className={cn(
                            'w-full max-w-2xl rounded-4xl  bg-card p-8    md:p-12 ',
                        ...
                        <div className="flex flex-wrap items-center justify-start gap-3 sm:justify-end">
                            <button
                                ...
                                className={cn(
                                    ...
                                    'rounded-full border px-7 py-2.5 text-sm font-medium transition-all duration-200 w-full md:w-fit'
                                )}
                            >
                                Accept All
                            </button>
                            <button
                                ...
                                className={cn(
                                    ...
                                    'border-border bg-background text-foreground hover:bg-muted w-full md:w-fit'
                                )}
                            >
                                Reject Optional
                            </button>
